...
const monthlyData = [
  ...
  { month: 'Jun', revenue: null, net: null, operating: null, source: 'Belum tersedia' },
    ...
    <main className="dashboard-shell">
      ...
      <section className="content-area">
        ...
        <div className="content-wrap">
          ...
          <div className="data-notice"><FileSpreadsheet size={18} /><span><strong>Sumber data:</strong> Sheet YTD PL pada BS-PL Juli 2026 · Laba bersih YTD: Rp 111.039,3 juta · Juni 2026 belum tersedia pada berkas sumber.</span><button>Detail sumber <ArrowUpRight size={14} /></button></div>
